...
import static com.hikvision.websocket.constants.CommonConstants.*;
...
public final class NetUtils {
    ...
    public static NetworkInterface findNetworkInterface() {
        ...
        if (result == null && CollectionUtils.isNotEmpty(validNetworkInterfaces)) {
            if (validNetworkInterfaces instanceof List) {
                List<NetworkInterface> list = (List<NetworkInterface>) validNetworkInterfaces;
                result = list.get(0);
            } else {
